...
const links = [
  ...
  { to: "/stretching", label: "Stretching", icon: StretchHorizontal, color: "text-cyan-400" },
  { to: "/cardio", label: "Cardio", icon: HeartPulse, color: "text-rose-400" },
];

export default function Sidebar() {
  return (
    <aside className="w-56 min-h-screen bg-[#07070c] border-r border-[#1a1b2e] p-5 flex flex-col">
      <div className="flex items-center gap-2 mb-8 px-2">
        <Activity className="w-5 h-5 text-emerald-400" />
        <span className="text-base font-bold tracking-tight text-white">Fitness</span>
      </div>
